...
(function () {
  ...
  var DICT = {
    en: {
      ...
      bioWilfredo: "Game designer from Peru, living sometimes in Germany.",
      roleMariya: "Lead artist",
      bioMariya: "Lead artist. The world of Ayakucho — its characters, cards and board — is painted by her.",
      roleMaja: "Additional art",
      bioMaja: "Contributing artist. She adds additional illustrations and graphic details across the game.",
      aiFree: "Apart from translations and proofreading, everything here is 100% AI-free: all the art, the game mechanics and three years of development are the work of these humans.",
    ...
    es: {
      ...
      bioWilfredo: "Diseñador de juegos peruano, que a veces vive en Alemania.",
      roleMariya: "Artista principal",
      bioMariya: "Artista principal. El mundo de Ayakucho — sus personajes, cartas y tablero — está pintado por ella.",
      ...
      aiFree: "Salvo las traducciones y su corrección, todo aquí es 100 % libre de IA: todo el arte, las mecánicas del juego y tres años de desarrollo son obra de estos humanos.",
    ...
    pt: {
      ...
      bioWilfredo: "Designer de jogos peruano, que às vezes vive na Alemanha.",
      roleMariya: "Artista principal",
      bioMariya: "Artista principal. O mundo de Ayakucho — seus personagens, cartas e tabuleiro — é pintado por ela.",
      roleMaja: "Arte adicional",
      bioMaja: "Artista colaboradora. Contribui com ilustrações adicionais e detalhes gráficos em todo o jogo.",
      aiFree: "Fora as traduções e a revisão, tudo aqui é 100% livre de IA: toda a arte, as mecânicas do jogo e três anos de desenvolvimento são obra destes humanos.",
    ...
    de: {
      ...
      bioWilfredo: "Spieledesigner aus Peru, der zeitweise in Deutschland lebt.",
      roleMariya: "Hauptillustratorin",
      bioMariya: "Hauptillustratorin. Die Welt von Ayakucho — Charaktere, Karten und Brett — ist von ihr gemalt.",
      ...
      aiFree: "Abgesehen von Übersetzungen und Korrekturlesen ist hier alles 100 % KI-frei: die gesamte Kunst, die Spielmechanik und drei Jahre Entwicklung sind das Werk dieser Menschen.",
    ...
    ru: {
      ...
      bioWilfredo: "Геймдизайнер из Перу, время от времени живущий в Германии.",
      roleMariya: "Главный художник",
      bioMariya: "Главный художник. Мир Ayakucho — персонажи, карты и поле — нарисован ею.",
      ...
      aiFree: "Не считая переводов и вычитки, здесь всё на 100 % свободно от ИИ: вся графика, игровые механики и три года разработки — дело рук этих людей.",
    ...
    be: {
      ...
      bioWilfredo: "Гейм-дызайнер з Перу, які часам жыве ў Германіі.",
      roleMariya: "Галоўная мастачка",
      bioMariya: "Галоўная мастачка. Свет Ayakucho — персанажы, карты і поле — намаляваны ёю.",
      roleMaja: "Дадатковыя ілюстрацыі",
      bioMaja: "Мастачка-суаўтарка. Дадае дадатковыя ілюстрацыі і графічныя дэталі па ўсёй гульні.",
      aiFree: "Не лічачы перакладаў і вычыткі, тут усё на 100 % свабоднае ад ШІ: усё мастацтва, гульнявыя механікі і тры гады распрацоўкі — справа рук гэтых людзей.",
