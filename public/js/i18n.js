...
(function () {
  ...
  var DICT = {
    en: {
      ...
      faq1more: "Ayakucho has a predecessor: <a href=\"https://boardgamegeek.com/boardgame/342455/bamberg\" target=\"_blank\" rel=\"noopener\">Bamberg</a>, born during the Covid years and sold to a British publisher in 2022. Seeing its potential unfulfilled, Wilfredo bought the license back in 2023, partnered up with Mariya, and started over. Three years of design and testing around Europe later, the game is finally ready.",
      faq2q: "How is this different from Werewolf, Blood on the Clocktower or Secret Hitler?",
      faq2a: "Anonymous voting — nobody sees who condemned whom, and that changes everything about how you bluff. Rounds are quick, and six players are enough for the basic game mode, so you don't need a big group. The second mode, for 8 to 12 players, splits the table into three teams — a favorite among social deduction veterans.",
      faq3q: "Where can I get it?",
      faq3a: "Back it on Kickstarter when the campaign launches on October 10, 2026. If it funds, the game reaches your door by the end of January 2027 — and not a day later. Wilfredo keeps his word: his previous game, <a href=\"https://www.kickstarter.com/projects/bamberg/bamberg-a-thrilling-game-of-social-deduction\" target=\"_blank\" rel=\"noopener\">Bamberg</a>, was funded on Kickstarter and delivered to 125 backers around the world.",
      more: "More",
      less: "Less",
      ...
      aiFree: "All art and game development are the work of humans: every illustration, every mechanic and three years of design are 100% AI-free. AI has been used only for this website's software development, translations and proofreading.",
    ...
    es: {
      ...
      aiFree: "Todo el arte y el desarrollo del juego son obra de humanos: cada ilustración, cada mecánica y tres años de diseño son 100 % libres de IA. La IA se ha usado solo para el desarrollo de esta página web, las traducciones y su corrección.",
    ...
    pt: {
      ...
      faq1more: "Ayakucho tem um antecessor: <a href=\"https://boardgamegeek.com/boardgame/342455/bamberg\" target=\"_blank\" rel=\"noopener\">Bamberg</a>, nascido nos anos de Covid e vendido a uma editora britânica em 2022. Vendo seu potencial não realizado, Wilfredo recomprou a licença em 2023, uniu-se a Mariya e recomeçou. Três anos de design e testes pela Europa depois, o jogo está finalmente pronto.",
      faq2q: "Qual a diferença para Lobisomem, Blood on the Clocktower ou Secret Hitler?",
      faq2a: "Voto anônimo: ninguém vê quem condenou quem, e isso muda tudo na hora de blefar. As rodadas são rápidas e seis jogadores bastam para o modo básico — você não precisa de um grupo enorme. O segundo modo, de 8 a 12 jogadores, divide a mesa em três equipes — o favorito dos veteranos do gênero.",
      faq3q: "Onde consigo o jogo?",
      faq3a: "Apoie no Kickstarter quando a campanha começar, em 10 de outubro de 2026. Se ela for financiada, o jogo chega à sua porta até o fim de janeiro de 2027 — e nem um dia depois. Wilfredo cumpre a palavra: seu jogo anterior, <a href=\"https://www.kickstarter.com/projects/bamberg/bamberg-a-thrilling-game-of-social-deduction\" target=\"_blank\" rel=\"noopener\">Bamberg</a>, foi financiado no Kickstarter e entregue a 125 apoiadores no mundo todo.",
      more: "Mais",
      less: "Menos",
      ...
      aiFree: "Toda a arte e o desenvolvimento do jogo são obra de humanos: cada ilustração, cada mecânica e três anos de design são 100% livres de IA. A IA foi usada apenas no desenvolvimento deste site, nas traduções e na revisão.",
    ...
    de: {
      ...
      faq1more: "Ayakucho hat einen Vorgänger: <a href=\"https://boardgamegeek.com/boardgame/342455/bamberg\" target=\"_blank\" rel=\"noopener\">Bamberg</a>, entstanden in den Covid-Jahren und 2022 an einen britischen Verlag verkauft. Weil sein Potenzial unerfüllt blieb, kaufte Wilfredo 2023 die Lizenz zurück, tat sich mit Mariya zusammen und fing neu an. Drei Jahre Design und Testrunden quer durch Europa später ist das Spiel endlich fertig.",
      faq2q: "Was unterscheidet es von Werwolf, Blood on the Clocktower oder Secret Hitler?",
      faq2a: "Anonyme Abstimmung: Niemand sieht, wer wen verurteilt hat — das verändert das Bluffen komplett. Die Runden sind kurz, und für den Basismodus reichen sechs Spieler — du brauchst also keine große Gruppe. Der zweite Modus, für 8 bis 12 Spieler, teilt den Tisch in drei Teams — der Favorit erfahrener Social-Deduction-Spieler.",
      faq3q: "Wo bekomme ich es?",
      faq3a: "Unterstütze es auf Kickstarter, wenn die Kampagne am 10. Oktober 2026 startet. Wird sie finanziert, steht dir das Spiel bis Ende Januar 2027 vor der Tür — und keinen Tag später. Wilfredo hält Wort: Sein vorheriges Spiel <a href=\"https://www.kickstarter.com/projects/bamberg/bamberg-a-thrilling-game-of-social-deduction\" target=\"_blank\" rel=\"noopener\">Bamberg</a> wurde auf Kickstarter finanziert und an 125 Unterstützer weltweit ausgeliefert.",
      more: "Mehr",
      less: "Weniger",
      ...
      aiFree: "Die gesamte Kunst und die Spielentwicklung sind Menschenwerk: jede Illustration, jede Mechanik und drei Jahre Design sind 100 % KI-frei. KI kam nur bei der Entwicklung dieser Website, den Übersetzungen und dem Korrekturlesen zum Einsatz.",
    ...
    ru: {
      ...
      aiFree: "Вся графика и разработка игры — дело рук людей: каждая иллюстрация, каждая механика и три года дизайна на 100 % свободны от ИИ. ИИ использовался только для разработки этого сайта, переводов и вычитки.",
    ...
    be: {
      ...
      faq1more: "У Ayakucho ёсць папярэднік: <a href=\"https://boardgamegeek.com/boardgame/342455/bamberg\" target=\"_blank\" rel=\"noopener\">Bamberg</a>, які нарадзіўся ў ковідныя гады і быў прададзены брытанскаму выдаўцу ў 2022-м. Бачачы, што патэнцыял гульні не раскрыты, Wilfredo выкупіў ліцэнзію ў 2023-м, аб'яднаўся з Mariya і пачаў нанова. Тры гады дызайну і тэстаў па ўсёй Еўропе — і гульня нарэшце гатовая.",
      faq2q: "Чым яна адрозніваецца ад Werewolf, Blood on the Clocktower ці Secret Hitler?",
      faq2a: "Ананімнае галасаванне: ніхто не бачыць, хто каго асудзіў, — і гэта цалкам мяняе блеф. Раўнды хуткія, для базавага рэжыму хапае шасці гульцоў — вялікая кампанія не патрэбная. Другі рэжым, на 8–12 гульцоў, дзеліць стол на тры каманды — фаварыт ветэранаў жанру.",
      faq3q: "Дзе яе ўзяць?",
      faq3a: "Падтрымай кампанію на Kickstarter, калі яна стартуе 10 кастрычніка 2026. Калі яна збярэ фінансаванне, гульня прыедзе да цябе да канца студзеня 2027 — і ні днём пазней. Wilfredo трымае слова: яго папярэдняя гульня <a href=\"https://www.kickstarter.com/projects/bamberg/bamberg-a-thrilling-game-of-social-deduction\" target=\"_blank\" rel=\"noopener\">Bamberg</a> была прафінансаваная на Kickstarter і дастаўленая 125 бэкерам па ўсім свеце.",
      more: "Яшчэ",
      less: "Згарнуць",
      ...
      aiFree: "Усё мастацтва і распрацоўка гульні — справа рук людзей: кожная ілюстрацыя, кожная механіка і тры гады дызайну на 100 % свабодныя ад ШІ. ШІ выкарыстоўваўся толькі для распрацоўкі гэтага сайта, перакладаў і вычыткі.",
      getInTouch: "Звязацца",
