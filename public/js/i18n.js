...
(function () {
  ...
  var DICT = {
    en: {
      ...
      bioWilfredo: "Game designer. A nomad from Peru, based nowhere.",
    ...
    es: {
      ...
      bioWilfredo: "Diseñador de juegos. Un nómada del Perú, sin base fija.",
    ...
    pt: {
      ...
      bioWilfredo: "Designer de jogos. Um nômade do Peru, baseado em lugar nenhum.",
      roleMariya: "Artista principal",
    ...
    de: {
      ...
      bioWilfredo: "Spieledesigner. Ein Nomade aus Peru — zuhause nirgendwo.",
    ...
    ru: {
      ...
      bioWilfredo: "Геймдизайнер. Кочевник из Перу, без постоянной базы.",
    ...
    be: {
      ...
      bioWilfredo: "Гейм-дызайнер. Качэўнік з Перу, без сталай базы.",
